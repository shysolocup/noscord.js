removes a user from the handler (same as [CooldownUserHandle.remove()](https://github.com/paigeroid/noscord.js/wiki/Commands.SlashCommand.CooldownHandle.CooldownUserHandle.remove()))<br>
type: `Function`<br><br>
